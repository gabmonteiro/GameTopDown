...
public class Tile {
    ...
    public static BufferedImage TILE_ROCK = Main.spriteSheet.getSprite(32, 48, 16, 16);
    public static BufferedImage TILE_DIRT_PATH = Main.spriteSheet.getSprite(16, 0, 16, 16);
